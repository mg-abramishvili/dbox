...
<script>
    ...
    import ShkolaNewsItemHorizontal from '../../components/news/shkola/show-horizontal'
    import MuzeiNewsItemVertical from '../../components/news/muzei/show-vertical'
