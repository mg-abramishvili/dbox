<template>
    <div class="container container-index">
        <div class="sortable">
            ...
            <swiper ref="DetsadIndexAllSwiper" :options="swiperOptions">
...
<script>
    ...
    export default {
        ...
        methods: {
            GoToPage(id, types) {
                this.$router.push({name: 'detsad_PageItem', params: {id: id}})
                this.$refs.DetsadIndexAllSwiper.$swiper.slideTo(1, false)
            ...
            GoToPhotoalbums() {
                this.$router.push({name: 'detsad_Photoalbums'})
                this.$refs.DetsadIndexAllSwiper.$swiper.slideTo(1, false)
            },
            GoToVideoalbums() {
                this.$router.push({name: 'detsad_Videoalbums'})
                this.$refs.DetsadIndexAllSwiper.$swiper.slideTo(1, false)
            },
            GoToReviews() {
                this.$router.push({name: 'detsad_Reviews'})
                this.$refs.DetsadIndexAllSwiper.$swiper.slideTo(1, false)
            },
            GoToRoutes() {
            ...
            GoToNews() {
                this.$router.push({name: 'detsad_News'})
                this.$refs.DetsadIndexAllSwiper.$swiper.slideTo(1, false)
            },
            swiperArrows() {
        ...
        computed: {
            swiper() {
                return this.$refs.DetsadIndexAllSwiper.$swiper
            }
        },
        components: {
            Swiper,
