<template>
    <div class="type-6 container-index" style="margin-top: -5vh; margin-left: -1vw">
        ...
        <h1 class="h1-page" style="font-weight: 700; font-size: 3.5vh; text-align: center; color: #87499C; margin-top: 8vh; margin-bottom: 3vh;">{{ page.title }}</h1>
