    ...
    <div>
        <div class="container container-index" style="position: relative; height: 100vh; background: transparent;">
            ...
            <div v-if="news.length" class="news-list sortable">
                <swiper ref="MuzeiNewsAllSwiper" :options="swiperOptions">
...
<script>
    ...
    export default {
        ...
        methods: {
            GoToNewsItem(id) {
                this.$router.push({name: 'muzei_NewsItem', params: {id: id}})
                this.$refs.MuzeiNewsAllSwiper.$swiper.slideTo(0, false)
            },
        },
        filters: {
        ...
        computed: {
            swiper() {
                return this.$refs.MuzeiNewsAllSwiper.$swiper
            }
        },
        components: {
            Swiper,
