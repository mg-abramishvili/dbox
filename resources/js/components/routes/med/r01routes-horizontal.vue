            ...
            <div class="col-7"> 
                ...
                <div id="map" style="position: relative;">
                    ...
                    <svg class="map-path svg1" viewBox="0 0 800 450">
                        ...
                        <text v-if="route.x_02" style="stroke: #ffffff; stroke-width: 0.5px;" :x='route.x_02' :y='route.y_02' font-family='Verdana' font-size='12' fill='red'><tspan dx='-20' dy='30' font-weight='bold'>{{ route.t_1_end }}</tspan></text>
                        ...
                        <text v-if="route.x_03" style="stroke: #ffffff; stroke-width: 0.5px;" :x='route.x_03' :y='route.y_03' font-family='Verdana' font-size='12' fill='red'><tspan dx='-20' dy='30' font-weight='bold'>{{ route.t_1_end }}</tspan></text>
                        ...
                        <text v-if="route.x_04" style="stroke: #ffffff; stroke-width: 0.5px;" :x='route.x_04' :y='route.y_04' font-family='Verdana' font-size='12' fill='red'><tspan dx='-20' dy='30' font-weight='bold'>{{ route.t_1_end }}</tspan></text>
                        ...
                        <text v-if="route.x_05" style="stroke: #ffffff; stroke-width: 0.5px;" :x='route.x_05' :y='route.y_05' font-family='Verdana' font-size='12' fill='red'><tspan dx='-20' dy='30' font-weight='bold'>{{ route.t_1_end }}</tspan></text>
                        ...
                        <text v-if="route.x_06" style="stroke: #ffffff; stroke-width: 0.5px;" :x='route.x_06' :y='route.y_06' font-family='Verdana' font-size='12' fill='red'><tspan dx='-20' dy='30' font-weight='bold'>{{ route.t_1_end }}</tspan></text>
                        ...
                        <text v-if="route.x_07" style="stroke: #ffffff; stroke-width: 0.5px;" :x='route.x_07' :y='route.y_07' font-family='Verdana' font-size='12' fill='red'><tspan dx='-20' dy='30' font-weight='bold'>{{ route.t_1_end }}</tspan></text>
                        ...
                        <text v-if="route.x_08" style="stroke: #ffffff; stroke-width: 0.5px;" :x='route.x_08' :y='route.y_08' font-family='Verdana' font-size='12' fill='red'><tspan dx='-20' dy='30' font-weight='bold'>{{ route.t_1_end }}</tspan></text>
                        ...
                        <text v-if="route.x_09" style="stroke: #ffffff; stroke-width: 0.5px;" :x='route.x_09' :y='route.y_09' font-family='Verdana' font-size='12' fill='red'><tspan dx='-20' dy='30' font-weight='bold'>{{ route.t_1_end }}</tspan></text>
                        ...
                        <text v-if="route.x_10" style="stroke: #ffffff; stroke-width: 0.5px;" :x='route.x_10' :y='route.y_10' font-family='Verdana' font-size='12' fill='red'><tspan dx='-20' dy='30' font-weight='bold'>{{ route.t_1_end }}</tspan></text>
                        ...
                        <text v-if="route.x_11" style="stroke: #ffffff; stroke-width: 0.5px;" :x='route.x_11' :y='route.y_11' font-family='Verdana' font-size='12' fill='red'><tspan dx='-20' dy='30' font-weight='bold'>{{ route.t_1_end }}</tspan></text>
                    ...
                    <svg class="map-path svg2" viewBox="0 0 800 450">
                        ...
                        <text v-if="route.x_102" style="stroke: #ffffff; stroke-width: 0.5px;" :x='route.x_102' :y='route.y_102' font-family='Verdana' font-size='12' fill='red'><tspan dx='-20' dy='30' font-weight='bold'>{{ route.t_2_end }}</tspan></text>
                        ...
                        <text v-if="route.x_103" style="stroke: #ffffff; stroke-width: 0.5px;" :x='route.x_103' :y='route.y_103' font-family='Verdana' font-size='12' fill='red'><tspan dx='-20' dy='30' font-weight='bold'>{{ route.t_2_end }}</tspan></text>
                        ...
                        <text v-if="route.x_104" style="stroke: #ffffff; stroke-width: 0.5px;" :x='route.x_104' :y='route.y_104' font-family='Verdana' font-size='12' fill='red'><tspan dx='-20' dy='30' font-weight='bold'>{{ route.t_2_end }}</tspan></text>
                        ...
                        <text v-if="route.x_105" style="stroke: #ffffff; stroke-width: 0.5px;" :x='route.x_105' :y='route.y_105' font-family='Verdana' font-size='12' fill='red'><tspan dx='-20' dy='30' font-weight='bold'>{{ route.t_2_end }}</tspan></text>
                        ...
                        <text v-if="route.x_106" style="stroke: #ffffff; stroke-width: 0.5px;" :x='route.x_106' :y='route.y_106' font-family='Verdana' font-size='12' fill='red'><tspan dx='-20' dy='30' font-weight='bold'>{{ route.t_2_end }}</tspan></text>
                        ...
                        <text v-if="route.x_107" style="stroke: #ffffff; stroke-width: 0.5px;" :x='route.x_107' :y='route.y_107' font-family='Verdana' font-size='12' fill='red'><tspan dx='-20' dy='30' font-weight='bold'>{{ route.t_2_end }}</tspan></text>
                        ...
                        <text v-if="route.x_108" style="stroke: #ffffff; stroke-width: 0.5px;" :x='route.x_108' :y='route.y_108' font-family='Verdana' font-size='12' fill='red'><tspan dx='-20' dy='30' font-weight='bold'>{{ route.t_2_end }}</tspan></text>
                        ...
                        <text v-if="route.x_109" style="stroke: #ffffff; stroke-width: 0.5px;" :x='route.x_109' :y='route.y_109' font-family='Verdana' font-size='12' fill='red'><tspan dx='-20' dy='30' font-weight='bold'>{{ route.t_2_end }}</tspan></text>
                        ...
                        <text v-if="route.x_110" style="stroke: #ffffff; stroke-width: 0.5px;" :x='route.x_110' :y='route.y_110' font-family='Verdana' font-size='12' fill='red'><tspan dx='-20' dy='30' font-weight='bold'>{{ route.t_2_end }}</tspan></text>
                        ...
                        <text v-if="route.x_111" style="stroke: #ffffff; stroke-width: 0.5px;" :x='route.x_111' :y='route.y_111' font-family='Verdana' font-size='12' fill='red'><tspan dx='-20' dy='30' font-weight='bold'>{{ route.t_2_end }}</tspan></text>
